...
#pragma warning(disable : 4996) /* don't want warning: 'strcat' may be unsafe */
                                /* don't want warning: 'strcpy' may be unsafe */
                                /* don't want warning: 'sprintf' may be unsafe */
                                /* don't want warning: 'localtime' may be unsafe */
                                /* don't want warning: the POSIX name for 'strupr' is deprecated */
                                /* don't want warning: the POSIX name for 'chdir' is deprecated */
  ...
  (PFileVar fv, PQVVar qv, PComVar cv, PTTSet ts)
{
  ...
  if (qv->QVMode==IdQVReceive)
    strcat(fv->DlgCaption,"mTerm: Quick-VAN Receive");
