...
#include wxSETUPH_PATH_STR // in IDE, expands to (mcduSim)\wx\lib\vc_lib\mswud\setup.h
        //   at compile time (debug), expands to (mcduSim)\wx\lib\vc_lib\mswud\wx\setup.h
        // at compile time (release), expands to (mcduSim)\wx\lib\vc_lib\mswu\wx\setup.h
