...
// Created:     1998/06/12
// RCS-ID:      $Id: wxcrt.h 63991 2010-04-16 10:43:18Z VS $
...
#pragma warning(disable : 4996) /* don't want warning: '_wopen','_wfopen','_wfreopen' and 'getenv','_wgetenv' and 'strcat','strcpy','strncat','strncpy' and 'wcscat','wcscpy','wcsncat','wcsncpy' all declared deprecated */
