...
#define wxUSE_DIALUP_MANAGER            0 /* need for wxDialUpManager class: handles network connect/disconnect, dial-up notification when network connection established/terminated. Requires wxUSE_DYNAMIC_LOADER */
...
#define wxUSE_STD_DEFAULT               0 /* default value for wxUSE_STD_IOSTREAM and wxUSE_STD_STRING */
#define wxUSE_STD_IOSTREAM              0 /* use 1 if using standard streams anyhow and dependency on standard streams library not problem */
#define wxUSE_STD_STRING                0 /* use 1 to enable conversion to standard C++ string */
...
#define wxUSE_TOOLTIPS                  0 /* used if wxUSE_GUI */
